...
for row in range(rows - 2):
    for column in range(columns - 2):
        ...
        current_sum = top_left + top_middle + top_right + middle_left + middle_middle + middle_right + down_left + down_middle + down_right
        if max_sum < current_sum:
            max_sum = current_sum
            square_matrix = [[top_left, top_middle, top_right], [middle_left, middle_middle, middle_right], [down_left, down_middle, down_right]]
